          ...
          <div className="grid grid-cols-3 gap-3 sm:grid-cols-5 lg:grid-cols-10">
            {tiles.map((c) => (
              <Link
                ...
                className="group flex flex-col items-center gap-2 rounded-lg border border-[var(--border)] bg-card p-3 text-center transition-all hover:-translate-y-0.5 hover:border-[var(--brand)]/40 hover:shadow-md"
              >
