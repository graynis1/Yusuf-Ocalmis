        ...
        <form onSubmit={onSave} className="animate-fade-up space-y-4 rounded-lg border border-[var(--border)] bg-card p-5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={10}
              className="w-full rounded-md border border-[var(--border)] bg-white p-3 font-mono text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]"
            />
